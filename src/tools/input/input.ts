...
import CameraInput from "./camera_input/CameraInput";
...
export namespace Input {
	...
	export function GetMoveVector(
		...
		if (follow_full_rotation)
			return current_camera.CFrame.Rotation.PointToWorldSpace(input_vector);
	...
	export function Initialize() {
		...
		const player_module_script = player_scripts.WaitForChild(
			"PlayerModule",
		) as ModuleScript;
